...
ggplot(data = purple_urchins_naples_2010,
       aes(x = size)) + 
  geom_histogram(aes(fill = treatment_type), bins = 10) + 
...
These two exploratory graphs suggest that the distribution of purple urchin sizes in control and experimental sites are normally distributed, according to the qq-plot's fairly linear trend. The control sites seem to have a slightly more normal distribution whereas experimental sites have a very strong trend for sizes around 3 cm. 
